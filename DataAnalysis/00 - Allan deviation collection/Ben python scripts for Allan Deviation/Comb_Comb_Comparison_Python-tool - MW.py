...
axdata = "mHz"#"mHz"#"Hz"
#show phasenosie limit 2E-19 in Phaseplot (1=yes)
limitpn = 1 #0#1
...
if limitpn == 1:
    plt.plot(TIME2h, f*r*5E-19*TIME2, '.-', color='r', linewidth=0.3, markersize=0.0, alpha=0.9, label = "5E-19")
    plt.plot(TIME2h, -f*r*5E-19*TIME2, '.-', color='r', linewidth=0.3, markersize=0.0, alpha=0.9)
