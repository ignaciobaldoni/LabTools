...
def calcAllanDev(df_Freqs, channels, channel_names, freq_rate = 1/0.1, 
    ...
    for i in channels:        
        ...
        makeTable(t2, ad, fig, print_freqs = t_tau)
...
if  __name__ == "__main__":
    ...
    folder = r'\\Menloserver\mfs\03-Operations\03-Production\05-AU_PA\AU07562-ORS-Mini-Menlo_Inc\02-Messdaten\Characterization\20230418'
    fileName = '230418_1_Frequ.txt'
    saveFigs                    = False      
    wavelength = 1542.14e-9    
