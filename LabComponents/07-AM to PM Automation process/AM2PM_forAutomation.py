...
def AM2PM(folder):
    ...
    return df.AM_to_PM.iloc[-1], df.AM_to_PM.iloc[0]
...
if __name__ == '__main__':
    folder = (r'\\menloserver\mfs\03-Operations\03-Production\05-AU_PA'+\
              ...
              r'\HHI Fraunhoffer (new)\AM to PM NIST\TEST FOR AUTOMATION\4.27 mW')
    last_am2pm, first_am2pm = AM2PM(folder)
    print(last_am2pm, first_am2pm)
