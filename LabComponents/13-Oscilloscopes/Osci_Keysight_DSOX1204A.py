...
class Oszi_Keysight_DSOX1204A():
    """Remote-Osci control: Keysight oscilloscope of type DSOX1204A
    ...
    #TODO: Write wrapper/decorator for updating the settings
    #TODO: Locking  
      
    # implementation of print(instance_Osci)
    def __str__(self):
        """prints an overview of current device settings"""
        
        
        return "member of Test"

    def __init__(self,
                 instrumentConnectionString: str = 'TCPIP0::169.254.155.41::INSTR',
                 deviceId: str = "DCP-Space-Osci"):
        """Initializes connection to oscilloscope and reads out current settings.
        
        Parameters
        ----------
        instrumentConnectionString : str
            Visa connection string of the tool (default is hard coded string of 
            current device in use)
        deviceId : str
            Unique identifier for the used osci
        ...
        self._logger = logging.getLogger(f"{__name__}.{deviceId}")
    ...
    def openConnectionOszi(self):
        ...
        #instrumentConnectionString =  'USB0::0x2A8D::0x0386::CN60176125::INSTR';
        # USB connecction to scope
        instrumentConnectionString =  'USB0::0x2A8D::0x0386::CN60176125::INSTR'
        # LAN connection to scope
        instrumentConnectionString =  'TCPIP0::169.254.155.41::INSTR'
    ...
    ####################################################################################
    def readScope(self,readOutChannelNumberList = [1],sampleRate=2e6,pointCount = 2e6,onlyReadOut = True,plotResult = False):
        ####################################################################################
    ...
    def _readScope(self,readOutChannelNumberList = [1],sampleRate=2e6,pointCount = 2e6,onlyReadOut = True,plotResult = False):
        # plotResult: 
...
#     print('avg: '+ str(avg)+ ' std: ' + str(std))
    ...
    data = tool._readOutChannels([1,2,4])
    tool.closeConnetion()
