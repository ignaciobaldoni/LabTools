...
def AM2PM(FOLDER,Folders, AMtoPM_characterization = True, 
          plot_figures = False,
          saveFigs = True, Title = None,Temperature=23, p=-1):
    ...
    for folder in Folders:
        ...
        print(power_levels)
        if 'unlocked' in power_levels:
            Power = float(power_levels.split(' ')[1])
        else:
    ...
    return min_AM2PM_dataframe,df.AM_to_PM, df.AM_to_PM.iloc[-1], df.Bias
