...
class ESA_Anritsu_MS2830A():
    ...
    def openConnectionESA(self):
        ...
        instrumentConnectionString =  'GPIB0::1::INSTR';
        ...
        self.instrumentManager.timeout = 3600000;
        
        self.instrumentManager.write("SYST:LANG SCPI")
    ...
    def peakDetect(self,markerNum = 1):
    ...
    def singleMeasurement(self):    
        ...
        instrumentManager.write(':INITiate:SWP')
        ...
        while finishedOperation:
            resp = instrumentManager.query_ascii_values(':INITiate:SWP?')
    ...
    def _readEsa(self,traceNumber = 1):
        readOutTraceNumber = traceNumber;
